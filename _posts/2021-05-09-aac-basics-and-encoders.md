...
AAC 是现代音视频链路里最常见的音频编码之一。它常常出现在播放器、短视频、流媒体、视频音轨和移动端文件里，但很多时候大家只记得“它比 MP3 更新”，对 profile、工具链和封装关系反而不够清楚。

## 1. AAC 为什么重要

AAC 的核心价值可以概括成一句话：**在相同或相近码率下，通常能比 MP3 提供更好的主观听感。**
...
你不一定需要掌握内部数学细节，但要知道它的目标始终是：**在有限码率下尽可能保住听感。**
