...
<section class="soc-home-hero">
  ...
  <p class="soc-home-lead">我把 SoC 拆成十一个可以独立理解、又能重新连回系统的数据路径。从 CPU 发出一次访问开始，顺着地址、数据、中断、核间通信和控制流，一直看到 Linux、外设和调试现场。</p>
  <div class="soc-home-stats">
    <span><strong>11</strong>核心模块</span>
    <span><strong>122</strong>篇笔记</span>
    <span><strong>167</strong>张架构图</span>
    <span><strong>5</strong>个实验</span>
  </div>
</section>
...
<section class="soc-home-section">
  ...
  <div class="soc-module-grid">
    ...
    <a href="11-Inter-Core-Communication/"><span>11</span><strong>核间通信</strong><em>Mailbox · Ring · RPMsg</em></a>
  </div>
</section>
...
<section class="soc-home-section soc-home-practice">
  ...
  <div class="soc-practice-grid">
    ...
    <a href="Labs/"><span>Labs</span><strong>五个可复现实验</strong><p>QEMU ARM64、DMA 一致性、弱内存序、Device Tree 驱动和核间 Ring。</p></a>
